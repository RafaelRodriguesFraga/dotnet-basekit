...
namespace DotnetBaseKit.Components.Tests.Unit.Domain.Sql.Entity
{
    public class BaseEntityTests
    {
        ...
        {
            var entity = new FakeBaseEntitySql();
        ...
        {
            var entity = new FakeBaseEntitySqlWithData("");
            entity.Validate();
        ...
        {
            var entity = new FakeBaseEntitySqlWithData("Rafael");
            entity.Validate();
